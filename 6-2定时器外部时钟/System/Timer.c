...
void Timer_Init(void)
{
	...
	TIM_ETRClockMode2Config(TIM2,TIM_ExtTRGPSC_OFF,TIM_ExtTRGPolarity_NonInverted,0x00); //选择时钟 TIM2
	...
	TIM_TimBaseStructure.TIM_Period=10-1;
	TIM_TimBaseStructure.TIM_Prescaler=10-1;    //1M=1乘10的六次方
